...
decode(&#39;win1251&#39;)     ~95 Mb/s      ~246 Mb/s</code></pre><h2>BOM handling</h2><ul>
...
<h2>Other notes</h2><p>When decoding, be sure to supply a Buffer to decode() method, otherwise <a href="https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding">bad things usually happen</a>.  
Untranslatable characters are set to � or ?. No transliteration is currently supported.<br>Node versions 0.10.31 and 0.11.13 are buggy, don&#39;t use them (see #65, #77).  </p>
