...
<h2>Installation</h2><pre><code class="language-sh">$ npm install content-type</code></pre>
<h2>API</h2><pre><code class="language-js">var contentType = require(&#39;content-type&#39;)</code></pre>
<h3>contentType.parse(string)</h3><pre><code class="language-js">var obj = contentType.parse(&#39;image/svg+xml; charset=utf-8&#39;)</code></pre>
...
<h3>contentType.parse(req)</h3><pre><code class="language-js">var obj = contentType.parse(req)</code></pre>
...
<h3>contentType.parse(res)</h3><pre><code class="language-js">var obj = contentType.parse(res)</code></pre>
...
<p>Throws a <code>TypeError</code> if the <code>Content-Type</code> header is missing or invalid.</p>
<h3>contentType.format(obj)</h3><pre><code class="language-js">var str = contentType.format({type: &#39;image/svg+xml&#39;})</code></pre>
