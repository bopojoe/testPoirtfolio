...
<pre><code class="language-sh">$ npm install accepts</code></pre>
<h2>API</h2><!-- eslint-disable no-unused-vars -->

<pre><code class="language-js">var accepts = require(&#39;accepts&#39;)</code></pre>
...
<pre><code class="language-sh">curl -I -H&#39;Accept: text/html&#39; http://localhost:3000/</code></pre>
