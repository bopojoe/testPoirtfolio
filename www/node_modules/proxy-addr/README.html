<h1>proxy-addr</h1><p><a href="https://npmjs.org/package/proxy-addr"><img src="https://badgen.net/npm/v/proxy-addr" alt="NPM Version"></a>
...
<pre><code class="language-sh">$ npm install proxy-addr</code></pre>
<h2>API</h2><!-- eslint-disable no-unused-vars -->

<pre><code class="language-js">var proxyaddr = require(&#39;proxy-addr&#39;)</code></pre>
...
proxyaddr(req, [&#39;::1/128&#39;, &#39;fe80::/10&#39;])</code></pre>
...
<pre><code class="language-js">proxyaddr.all(req)</code></pre>
...
<pre><code class="language-js">proxyaddr.all(req, &#39;loopback&#39;)</code></pre>
...
<h2>Benchmarks</h2><pre><code class="language-sh">$ npm run-script bench</code></pre>
