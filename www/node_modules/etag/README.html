...
<pre><code class="language-sh">$ npm install etag</code></pre>
<h2>API</h2><!-- eslint-disable no-unused-vars -->

<pre><code class="language-js">var etag = require(&#39;etag&#39;)</code></pre>
...
<pre><code class="language-js">res.setHeader(&#39;ETag&#39;, etag(body))</code></pre>
...
&gt; node benchmark/stats.js
  ...
  fake - weak   x 400,100 ops/sec ±0.47% (188 runs sampled)</code></pre>
