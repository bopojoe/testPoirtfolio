<h1>qs <sup><a href="https://npmjs.org/package/qs"><img src="http://versionbadg.es/ljharb/qs.svg" alt="Version Badge"></a></sup></h1><p><a href="https://travis-ci.org/ljharb/qs"><img src="https://api.travis-ci.org/ljharb/qs.svg" alt="Build Status"></a>
...
assert.equal(str, &#39;a=c&#39;);</code></pre>
<h3>Parsing Objects</h3><p><a href="#preventEval"></a></p>
<pre><code class="language-javascript">qs.parse(string, [options]);</code></pre>
...
assert.deepEqual(nullObject, { a: { hasOwnProperty: &#39;b&#39; } });</code></pre>
...
assert.deepEqual(protoObject, { a: { hasOwnProperty: &#39;b&#39; } });</code></pre>
...
assert.deepEqual(qs.parse(string), expected);</code></pre>
...
assert.deepEqual(deep, { a: { b: { &#39;[c][d][e][f][g][h][i]&#39;: &#39;j&#39; } } });</code></pre>
...
assert.deepEqual(limited, { a: &#39;b&#39; });</code></pre>
...
assert.deepEqual(regexed, { a: &#39;b&#39;, c: &#39;d&#39;, e: &#39;f&#39; });</code></pre>
...
assert.deepEqual(withDots, { a: { b: &#39;c&#39; } });</code></pre>
...
assert.deepEqual(oldCharset, { a: &#39;§&#39; });</code></pre>
...
assert.deepEqual(detectedAsIso8859_1, { a: &#39;ø&#39; });</code></pre>
...
assert.deepEqual(detectedAsIso8859_1, { a: &#39;☺&#39; });</code></pre>
...
assert.deepEqual(noSparse, { a: [&#39;b&#39;, &#39;c&#39;] });</code></pre>
...
assert.deepEqual(withIndexedEmptyString, { a: [&#39;b&#39;, &#39;&#39;, &#39;c&#39;] });</code></pre>
...
assert.deepEqual(withMaxIndex, { a: { &#39;100&#39;: &#39;b&#39; } });</code></pre>
...
assert.deepEqual(withArrayLimit, { a: { &#39;1&#39;: &#39;b&#39; } });</code></pre>
...
assert.deepEqual(noParsingArrays, { a: { &#39;0&#39;: &#39;b&#39; } });</code></pre>
...
<pre><code class="language-javascript">qs.stringify(object, [options]);</code></pre>
...
assert.equal(qs.stringify({ a: { b: &#39;c&#39; } }), &#39;a%5Bb%5D=c&#39;);</code></pre>
...
assert.equal(unencoded, &#39;a[b]=c&#39;);</code></pre>
...
assert.equal(encodedValues,&#39;a=b&amp;c[0]=d&amp;c[1]=e%3Df&amp;f[0][0]=g&amp;f[1][0]=h&#39;);</code></pre>
...
<pre><code class="language-javascript">assert.equal(qs.stringify({ a: &#39;&#39; }), &#39;a=&#39;);</code></pre>
...
assert.equal(qs.stringify({ a: { b: {}} }), &#39;&#39;);</code></pre>
<p>Properties that are set to <code>undefined</code> will be omitted entirely:</p>
<pre><code class="language-javascript">assert.equal(qs.stringify({ a: null, b: undefined }), &#39;a=&#39;);</code></pre>
<p>The query string may optionally be prepended with a question mark:</p>
<pre><code class="language-javascript">assert.equal(qs.stringify({ a: &#39;b&#39;, c: &#39;d&#39; }, { addQueryPrefix: true }), &#39;?a=b&amp;c=d&#39;);</code></pre>
<p>The delimiter may be overridden with stringify as well:</p>
<pre><code class="language-javascript">assert.equal(qs.stringify({ a: &#39;b&#39;, c: &#39;d&#39; }, { delimiter: &#39;;&#39; }), &#39;a=b;c=d&#39;);</code></pre>
...
assert.equal(qs.stringify({ a: &#39;c&#39;, z: &#39;y&#39;, b : &#39;f&#39; }, { sort: alphabeticalSort }), &#39;a=c&amp;b=f&amp;z=y&#39;);</code></pre>
...
assert.equal(withNull, &#39;a=&amp;b=&#39;);</code></pre>
...
assert.deepEqual(equalsInsensitive, { a: &#39;&#39;, b: &#39;&#39; });</code></pre>
...
assert.equal(strictNull, &#39;a&amp;b=&#39;);</code></pre>
...
assert.deepEqual(parsedStrictNull, { a: null, b: &#39;&#39; });</code></pre>
...
assert.equal(nullsSkipped, &#39;a=b&#39;);</code></pre>
...
assert.equal(iso, &#39;%E6=%E6&#39;);</code></pre>
...
assert.equal(numeric, &#39;a=%26%239786%3B&#39;);</code></pre>
...
assert.equal(isoSentinel, &#39;utf8=%26%2310003%3B&amp;a=%E6&#39;);</code></pre>
<h3>Dealing with special character sets</h3><p>By default the encoding and decoding of characters is done in <code>utf-8</code>,
...
assert.equal(shiftJISEncoded, &#39;a=%82%B1%82%F1%82%C9%82%BF%82%CD%81I&#39;);</code></pre>
...
assert.deepEqual(obj, { a: &#39;こんにちは！&#39; });</code></pre>
