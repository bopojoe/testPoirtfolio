...
<pre><code class="language-sh">$ npm install depd</code></pre>
...
<pre><code class="language-js">var deprecate = require(&#39;depd&#39;)(&#39;my-module&#39;)</code></pre>
...
<pre><code>DeprecationError: my-cool-module deprecated oldfunction
    ...
    at node.js:902:3</code></pre><h3>process.env.NO_DEPRECATION</h3><p>As a user of modules that are deprecated, the environment variable <code>NO_DEPRECATION</code>
is provided as a quick solution to silencing deprecation warnings from being
output. The format of this is similar to that of <code>DEBUG</code>:</p>
<pre><code class="language-sh">$ NO_DEPRECATION=my-module,othermod node app.js</code></pre>
...
<pre><code class="language-sh">$ TRACE_DEPRECATION=my-module,othermod node app.js</code></pre>
...
namespace      |          |           location of mycoolmod.oldfunction() call
               |          deprecation message
               the word &quot;deprecated&quot;</code></pre><p>If the user redirects their STDERR to a file or somewhere that does not support
...
timestamp of message          namespace      |          |             location of mycoolmod.oldfunction() call
                                             |          deprecation message
                                             the word &quot;deprecated&quot;</code></pre><h2>Examples</h2><h3>Deprecating all calls to a function</h3><p>This will display a deprecated message about &quot;oldfunction&quot; being deprecated
