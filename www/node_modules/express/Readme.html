...
<h3>Security Issues</h3><p>If you discover a security vulnerability in Express, please see <a href="Security.md">Security Policies and Procedures</a>.</p>
...
<pre><code class="language-bash">$ npm install -g express-generator@4</code></pre>
<p>  Create the app:</p>
<pre><code class="language-bash">$ express /tmp/foo &amp;&amp; cd /tmp/foo</code></pre>
...
<pre><code class="language-bash">$ node examples/content-negotiation</code></pre>
<h2>Tests</h2><p>  To run the test suite, first install the dependencies, then run <code>npm test</code>:</p>
<pre><code class="language-bash">$ npm install
$ npm test</code></pre>
<h2>Contributing</h2><p><a href="Contributing.md">Contributing Guide</a></p>
<h2>People</h2><p>The original author of Express is <a href="https://github.com/tj">TJ Holowaychuk</a></p>
