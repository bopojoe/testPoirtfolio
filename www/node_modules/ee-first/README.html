...
<h2>Install</h2><pre><code class="language-sh">$ npm install ee-first</code></pre>
<h2>API</h2><pre><code class="language-js">var first = require(&#39;ee-first&#39;)</code></pre>
