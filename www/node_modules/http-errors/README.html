<h1>http-errors</h1><p><a href="https://npmjs.org/package/http-errors"><img src="https://badgen.net/npm/v/http-errors" alt="NPM Version"></a>
...
<pre><code class="language-bash">$ npm install http-errors</code></pre>
...
<h3>createError([status], [message], [properties])</h3><p>Create a new error object with the given message <code>msg</code>.
The error object inherits from <code>createError.HttpError</code>.</p>
<!-- eslint-disable no-undef, no-unused-vars -->

<pre><code class="language-js">var err = createError(404, &#39;This video does not exist!&#39;)</code></pre>
<ul>
...
<h3>createError([status], [error], [properties])</h3><p>Extend the given <code>error</code> object with <code>createError.HttpError</code>
...
<h3>new createError[code || name]([msg]))</h3><p>Create a new error object with the given message <code>msg</code>.
The error object inherits from <code>createError.HttpError</code>.</p>
<!-- eslint-disable no-undef, no-unused-vars -->

<pre><code class="language-js">var err = new createError.NotFound()</code></pre>
<ul>
...
<h4>List of all constructors</h4><table>
<thead>
<tr>
<th>Status Code</th>
